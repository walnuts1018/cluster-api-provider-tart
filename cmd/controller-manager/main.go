...
import (
	...
	applicationinplaceupdate "github.com/walnuts1018/cluster-api-provider-tart/domain/provisioning/workflow/update_machine"
	agentsessiondomain "github.com/walnuts1018/cluster-api-provider-tart/domain/shared/agentsession"
	"github.com/walnuts1018/cluster-api-provider-tart/infrastructure/http_server/agentapi"
	"github.com/walnuts1018/cluster-api-provider-tart/infrastructure/http_server/agentboot"
	"github.com/walnuts1018/cluster-api-provider-tart/infrastructure/http_server/bootstrapper"
	"github.com/walnuts1018/cluster-api-provider-tart/infrastructure/http_server/extension"
	webhookv1beta1 "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/k8s_webhook/v1beta1"
	"github.com/walnuts1018/cluster-api-provider-tart/infrastructure/provisioning_agent/artifactfetch"
	k8sagentapi "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/agentapi"
	k8sagentboot "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/agentboot"
	...
	k8sinitialprovisioning "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/initialprovisioning"
	k8sinplaceupdate "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/inplaceupdate"
	k8snodelifecycle "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/nodelifecycle"
	...
	k8soperation "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/repository/k8s/operation"
	...
	registrycredential "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/service/registry_credential"
	signingkey "github.com/walnuts1018/cluster-api-provider-tart/infrastructure/service/signing_key"
...
func main() {
	...
	if osArtifactKeyID != "" || osArtifactPublicKeyFile != "" || agentPlanKeyID != "" || agentPlanPrivateKeyFile != "" {
		...
		hostService := k8sv1beta1host.NewService(mgr.GetClient())
		operationService := k8soperation.NewService(mgr.GetClient())
		...
		reconcilers.TartMachineV1Beta1.Provisioner = k8sinitialprovisioning.NewService(
			...
			manifestResolver,
			workflow,
			completeprovisioning.NewWorkflow(operationService, hostService),
		)
	}
