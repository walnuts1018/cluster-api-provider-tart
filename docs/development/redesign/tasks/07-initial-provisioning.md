...
- `docs/development/redesign/runbooks/07-initial-provisioning-simulated-record.md` に、Bootstrap payload削除、単回Session、`AwaitingHealth`維持、Cleaning phase遷移の疑似証跡と、GitHub Actions上のProvisioning E2E証跡を追加した
