...
type ResourceReader interface {
	GetHost(context.Context, infrastructurev1beta1.ResourceReference) (*infrastructurev1beta1.TartHost, error)
	GetMachine(context.Context, infrastructurev1beta1.ResourceReference) (*infrastructurev1beta1.TartMachine, error)
}

type StatusWriter interface {
	TransitionPhase(context.Context, *infrastructurev1beta1.TartHostOperation, infrastructurev1beta1.TartHostOperationPhase) error
	HandleBootTrialDeadline(context.Context, *infrastructurev1beta1.TartHostOperation) error
	TransitionUpdateFailure(
		context.Context,
		*infrastructurev1beta1.TartHostOperation,
		infrastructurev1beta1.TartHostOperationPhase,
		infrastructurev1beta1.TartHostOperationPhase,
	) error
}
