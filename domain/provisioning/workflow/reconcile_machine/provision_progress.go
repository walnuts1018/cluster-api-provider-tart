...
type provisionProgressPorts interface {
...
type provisionProgress struct {
	steps provisionProgressPorts
}

func newProvisionProgress(steps provisionProgressPorts) *provisionProgress {
	return &provisionProgress{steps: steps}
}

func (handler *provisionProgress) run(
	ctx context.Context,
...
func (handler *provisionProgress) handleResolved(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
