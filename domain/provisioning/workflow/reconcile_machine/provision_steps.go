...
func (steps *workflowRuntime) ensureProvisionReferenceStep(
	ctx context.Context,
	...
	if errors.Is(err, allocationdomain.ErrConflict) {
		...
		machine.Status = machineexecutionstep.StatusWithAllocationConflict(machine, err.Error())
...
func (steps *workflowRuntime) startProvisionStep(
	ctx context.Context,
	provisioning provisioningMachine,
) error {
	machine := provisioning.Machine
...
func (steps *workflowRuntime) applyProvisionStartStatusPatchStep(
	ctx context.Context,
...
func (steps *workflowRuntime) resolveProvisionStartDependencyStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) checkBootstrapReadinessStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) reserveProvisionHostStep(
	ctx context.Context,
	provisioner Provisioner,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) ensureProviderIDStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) patchProvisionStartStatusStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
	patch model.ProvisionStartStatusPatch,
...
func (steps *workflowRuntime) resolveProvisionProgressReferenceStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) clearStaleProvisionOperationReferenceStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) patchProvisionFailureStatusStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) completeProvisionStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) resolveProvisionCompletionDependencyStep() provisionCompletionDependencyResult {
	if steps.Provisioner == nil {
...
func (steps *workflowRuntime) resolveProvisionCompletionHostStep(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (steps *workflowRuntime) setProvisionHealthPendingStep(
	machine *infrastructurev1beta1.TartMachine,
