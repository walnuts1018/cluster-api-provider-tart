...
type PersistAgentPlan struct {
	Operation *infrastructurev1beta1.TartHostOperation
	Plan      agentprotocol.ValidatedPlan
	Signature agentprotocol.Signature
}

type PersistNodeLifecyclePlan struct {
	Operation *infrastructurev1beta1.TartHostOperation
	Plan      nodelifecycleapp.ValidatedPlan
	Signature agentprotocol.Signature
}

func (StartOperation) isInPlaceUpdateStep()           {}
func (PersistAgentPlan) isInPlaceUpdateStep()         {}
func (PersistNodeLifecyclePlan) isInPlaceUpdateStep() {}
