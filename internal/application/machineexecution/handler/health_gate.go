...
type HealthGateSteps interface {
	PlanHealthGateRoute(
		context.Context,
...
type HealthGateHandler struct {
	steps HealthGateSteps
}

func NewHealthGateHandler(steps HealthGateSteps) *HealthGateHandler {
	return &HealthGateHandler{steps: steps}
}

func (handler *HealthGateHandler) Handle(
	ctx context.Context,
...
func (handler *HealthGateHandler) handleRoute(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (handler *HealthGateHandler) applyProvision(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
...
func (handler *HealthGateHandler) applyUpdate(
	ctx context.Context,
	machine *infrastructurev1beta1.TartMachine,
	operation *infrastructurev1beta1.TartHostOperation,
	observation machinehealthdomain.NodeObservation,
