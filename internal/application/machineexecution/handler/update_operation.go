...
type UpdateOperationSteps interface {
...
type UpdateOperationHandler struct {
	steps UpdateOperationSteps
}

func NewUpdateOperationHandler(steps UpdateOperationSteps) *UpdateOperationHandler {
	return &UpdateOperationHandler{steps: steps}
}

func (handler *UpdateOperationHandler) Handle(
	ctx context.Context,
...
func (handler *UpdateOperationHandler) handleDecision(
	ctx context.Context,
