...
func (executor *Executor) Apply(
...
) (resourcefinalizermodel.Result, error) {
	...
	case resourcefinalizerdomain.CommandAdd:
		return resourcefinalizermodel.ResultPatched{}, executor.patch(ctx, object, controllerutil.AddFinalizer)
	case resourcefinalizerdomain.CommandRemove:
		return resourcefinalizermodel.ResultPatched{}, executor.patch(ctx, object, controllerutil.RemoveFinalizer)
	case resourcefinalizerdomain.CommandNoop:
		return resourcefinalizermodel.ResultUnchanged{}, nil
	default:
