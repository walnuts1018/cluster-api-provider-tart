...
func TestTartMachineV1Beta1Reconcilerは削除時にCleaningOperationを開始する(t *testing.T) {
	...
	machine := &infrastructurev1beta1.TartMachine{
		ObjectMeta: metav1.ObjectMeta{
			...
			Finalizers:        []string{tartMachineCleanupFinalizer},
	...
	if len(current.Finalizers) != 1 || current.Finalizers[0] != tartMachineCleanupFinalizer {
...
func (s *cleaningOrchestratorStub) StartCleaning(
	_ context.Context,
	_ *infrastructurev1beta1.TartMachine,
